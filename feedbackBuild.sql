...
CREATE TABLE IF NOT EXISTS `mydb`.`Lecturers_has_Project` (
  ...
  INDEX `fk_Lecturers_has_Project_Project1_idx` (`idProject` ASC) VISIBLE,
  INDEX `fk_Lecturers_has_Project_Lecturers1_idx` (`idLecturers` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`SubSection` (
  ...
  INDEX `fk_subSection_Criteria1_idx` (`idCriteria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ShortText` (
  ...
  INDEX `fk_shortText_subSection1_idx` (`idSubSection` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`LongText` (
  ...
  INDEX `fk_longText_shortText1_idx` (`idShortText` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`CriteriaComment` (
  ...
  INDEX `fk_CriteriaComment_Mark1_idx` (`idMark` ASC) VISIBLE,
